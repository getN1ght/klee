...
bool TimingSolver::getValidAssignment(
  ...
  assert(solverResponse->getInitialValuesFor(requestedSymcretes, requestedSymcretesConcretization));
  ...
  solverResponse->getInitialValuesFor(requestedSymcretes, requestedSymcretesConcretization);
